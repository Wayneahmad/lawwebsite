...
import officeImage from "../../assets/buildyourcareer.jpg";
...
export default function JoinUsInvite({
  ...
  return (
    <Section ariaLabelledby="join-title" bg="bg-page" topFade topRule>
      <div className="rounded-3xl border border-slate-200 bg-gradient-to-tr from-white via-white to-[var(--page-bg)] p-6 sm:p-8 lg:p-10">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-center">
          ...
          >
            ...
            <h2
              id="join-title"
              className="mt-2 text-slate-900 font-semibold leading-[1.06] text-[clamp(22px,4.8vw,36px)] max-w-[28ch]"
            >
              {heading}
            </h2>
          ...
          >
            <div className="relative">
              ...
              <div className="aspect-[16/10] overflow-hidden rounded-3xl ring-1 ring-slate-200 bg-white shadow-[0_12px_32px_rgba(10,22,50,.10)]">
                <img
                  src={image}
